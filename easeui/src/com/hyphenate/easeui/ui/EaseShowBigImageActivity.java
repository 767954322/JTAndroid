...
public class EaseShowBigImageActivity extends EaseBaseActivity {
	...
	private RelativeLayout rl_all_big_imag;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		rl_all_big_imag  = (RelativeLayout)findViewById(R.id.rl_all_big_imag);
		rl_all_big_imag.setOnClickListener(new OnClickListener() {
			@Override
