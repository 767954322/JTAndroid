...
public class BeiCityFragment extends BaseFragment implements View.OnClickListener, PullToRefreshLayout.OnRefreshListener, ListView.OnItemClickListener {
    ...
    private static BeiCityFragment twoCityFragment;

    public static BeiCityFragment getInstance(int position, Context context) {
        if (twoCityFragment == null) {
            twoCityFragment = new BeiCityFragment(position, context);
        }
        consumerHomeActivity = (ConsumerHomeActivity) context;
        return twoCityFragment;
    }

    private BeiCityFragment(int position, Context context) {
