...
public class GuangCityFragment extends BaseFragment implements View.OnClickListener, PullToRefreshLayout.OnRefreshListener, ListView.OnItemClickListener {
    ...
    private static GuangCityFragment fourCityFragment;

    public static GuangCityFragment getInstance(int position, Context context) {
        if (fourCityFragment == null) {
            fourCityFragment = new GuangCityFragment(position, context);
        }
        consumerHomeActivity = (ConsumerHomeActivity) context;
        return fourCityFragment;
    }

    private GuangCityFragment(int position, Context context) {
