...
public class AllCityFragment extends BaseFragment implements View.OnClickListener, PullToRefreshLayout.OnRefreshListener, ListView.OnItemClickListener {
    ...
    private static AllCityFragment oneCityFragment;

    public static AllCityFragment getInstance(int position, Context context) {
        if (oneCityFragment == null) {
            oneCityFragment = new AllCityFragment(position, context);
        }
        consumerHomeActivity = (ConsumerHomeActivity) context;
        return oneCityFragment;
    }

    private AllCityFragment(int position, Context context) {
