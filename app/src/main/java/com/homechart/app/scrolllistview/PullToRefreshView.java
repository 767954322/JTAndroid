...
public class PullToRefreshView extends LinearLayout {
    ...
    /**
     * ic_default_head view current state
     */
    ...
    private void init() {
        ...
        // ic_default_head view 在此添加,保证是第一个添加到linearlayout的最上端
        addHeaderView();
    }
...
//                    headerPrepareToRefresh(deltaY);
    ...
    /**
     * ic_default_head 准备刷新,手指移动过程,还没有释放
     *
    ...
    /**
     * ic_default_head view 完成更新后恢复初始状态
     */
    ...
    /**
     * Interface definition for a callback to be invoked when list/grid ic_default_head
     * view should be refreshed.
     */
