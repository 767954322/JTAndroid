 ...
 */
package com.flexible.flexibleadapter;
...
import com.flexible.R;
import com.flexible.flexibleadapter.helpers.ItemTouchHelperCallback;
import com.flexible.flexibleadapter.helpers.StickyHeaderHelper;
import com.flexible.flexibleadapter.items.IExpandable;
import com.flexible.flexibleadapter.items.IFilterable;
import com.flexible.flexibleadapter.items.IFlexible;
...
import static com.flexible.flexibleadapter.utils.Utils.getClassName;
...
public class FlexibleAdapter<T extends IFlexible>
	 ...
	 * constructor: {@link #(View, FlexibleAdapter, boolean)}.</li>
	 ...
	 * @see IFlexible#(FlexibleAdapter, LayoutInflater, ViewGroup)
	 * @since 5.0.0-b1
	 */
	@Override
...
//					Log.v(TAG, "Adjust Selected position " + position + " to " + Math.max(position + itemCount, startPosition));
	...
	public interface OnItemLongClickListener {
		 ...
		 * <p>This method always calls {@link #()}
