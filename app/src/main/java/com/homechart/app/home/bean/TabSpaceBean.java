...
public class TabSpaceBean implements Serializable {
    ...
    private List<TabOneChild> child;

    public TabSpaceBean(List<TabOneChild> child, String space_tag_id, String space_tag_name, String space_tag_image_url, int space_tag_image_height, int space_tag_image_width) {
        this.child = child;
    ...
    public List<TabOneChild> getChild() {
        return child;
    }

    public void setChild(List<TabOneChild> child) {
        this.child = child;
    }
